...
export const INITIAL_COLLECTION_PRODUCTS = [
  { id: "3f8b5e7a-9d2a-4c1b-b6a2-1a8f0d5e2c11", name: "Neural Network Tee", collection: "ai-tech", price: 1299, originalPrice: 1899, image: null, sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["#0a0a0a", "#1a1a2e", "#f0ede8"], rating: 4.8, reviews: 234, tag: "BESTSELLER", description: "Minimal circuit-board motif. 100% Egyptian cotton, 240 GSM.", stock: 45 },
