...
const FAQS = [
  ...
  { cat: "ORDERS", q: "Can I modify or cancel my order?", type: "orders-help" },
  { cat: "ORDERS", q: "Is COD available?", a: "Yes! Cash on Delivery is available for orders up to Rs.5,000 at select pin codes. A Rs.50 handling fee applies." },
  ...
  { cat: "SHIPPING", q: "My order hasn't updated in 48 hours.", type: "shipping-help" },
...
function FAQItem({ faq, isOpen, onToggle }) {
  return (
    <div style={{ border: `1px solid ${isOpen ? gold + "55" : border}`, marginBottom: 8, transition: "border-color 0.3s" }}>
      <button onClick={onToggle} style={{ all: "unset", width: "100%", padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer", boxSizing: "border-box" }}>
      ...
      <div style={S.wrap}>
        ...
        <div style={{ background: surface, border: `1px solid ${border}`, padding: "28px", textAlign: "center", marginTop: 20 }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            {[
              { label: "EMAIL SUPPORT", val: "support@velvetwolf.in", href: "mailto:support@velvetwolf.in" },
              { label: "WHATSAPP", val: "+91 98765 43210", href: "https://wa.me/919876543210" },
            ].map((c, i) => (
              <a key={i} href={c.href} target={c.href.startsWith("http") ? "_blank" : undefined} rel={c.href.startsWith("http") ? "noreferrer" : undefined} style={{ border: `1px solid ${gold}55`, padding: "10px 20px", textAlign: "left", textDecoration: "none" }}>
