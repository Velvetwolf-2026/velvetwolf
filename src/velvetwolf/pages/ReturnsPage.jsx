// ─────────────────────────────────────────────
// VelvetWolf — Returns & Exchange Page
// Route: /returns
// ─────────────────────────────────────────────
...
const STAT_CARDS = [
  ...
  { icon:"✓",   label:"FREE EXCHANGE",  desc:"Size exchanges at no extra cost" },
  { icon:"₹",   label:"STORE CREDIT",   desc:"Instant credit, no wait" },
];

const STEPS = [
  { step:"01", title:"EMAIL US",       desc:"Send an email to returns@velvetwolf.in with your order ID, items to return, and reason. Attach photos if defective." },
