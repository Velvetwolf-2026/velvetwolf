        ...
        <div className="shop-sidebar" style={{ width: 220, flexShrink: 0 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <button onClick={() => handleCollectionClick(null)} style={{ background: "none", border: "none", cursor: "pointer", color: !activeCollection ? "var(--gold)" : "var(--silver)", fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: 2, textAlign: "left", padding: "4px 0" }}>ALL</button>
              {COLLECTIONS.map(col => (
