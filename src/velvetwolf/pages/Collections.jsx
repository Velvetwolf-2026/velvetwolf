...
export const INITIAL_COLLECTION_PRODUCTS = [
  ...
  { id: "8a1c4d92-5f3e-4c8b-9f2a-6d7b1e0c3a44", name: "Silent Predator", collection: "silent-luxury", price: 2499, originalPrice: 3200, image: "/mockup_silent.png", modelImage: "/model_silent.png", sizes: ["S", "M", "L", "XL"], colors: ["#0a0a0a", "#2c2c2c"], rating: 4.9, reviews: 189, tag: "LIMITED", description: "Embossed wolf crest. Supima cotton, hand-stitched details.", stock: 12 },
  { id: "c2d91a6e-3f5b-4b7a-a9e1-2d8c6f4b7e55", name: "Founder's Mindset", collection: "founder", price: 1599, originalPrice: 1999, image: "/mockup_founder.png", modelImage: "/model_founder.png", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["#0a0a0a", "#1a1a1a", "#faf9f7"], rating: 4.7, reviews: 312, tag: "NEW", description: "Bold motivational typography. Heavyweight fleece blend.", stock: 78 },
