          ...
          <div>
            ...
            {CONTACTS.map((c, i) => (
              <div key={i} style={{ display: "flex", gap: 14, marginBottom: 20, paddingBottom: 20, borderBottom: `1px solid ${border}` }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Roboto', sans-serif", fontSize: 10, letterSpacing: 3, color: muted, marginBottom: 3 }}>
                    {c.label}
                  </div>

                  {c.val === "info@velvetwolf.in" ? (
                    <a
                      href="mailto:info@velvetwolf.in"
                      style={{ fontSize: 15, color: gold, textDecoration: "none" }}
                    >
                      {c.val}
                    </a>
                  ) : (
